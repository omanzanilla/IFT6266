...
This code builds over the Cae_BigDense.py contextual auto-encoder to generate the inpainting
of the images of the project https://ift6266h17.wordpress.com/project-description/
and introduces leaky ReLUs in the structure, which might provide more control 
over "where" the parameters are for each unit, when they reach the lower saturation
point.
...
Note: This is the "build" function used in Experiment 3.      
"""  
def build(inputVar):
    import lasagne
